...
export default function Modal({
  ...
  return (
    ...
    >
      <div
        className={`w-full ${sizes[size]} bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-t-xl sm:rounded-xl max-h-[90vh] sm:max-h-[85vh] overflow-y-auto`}
      ...
      >
        ...
        <div className="p-4 sm:p-6 text-neutral-900 dark:text-neutral-100">
          {children}
        </div>
      </div>
    </div>
